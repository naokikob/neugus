...
(declare-fun |main@_45| ( Int Int Int Int Bool Int Int Int Int Int Int ) Bool)
...
(declare-fun |main@_40| ( Int Int Int Int Int Int Int Int Int ) Bool)
...
(declare-fun |main@_42| ( Int Int Int Int Bool Int Int Int Int Int Int ) Bool)
  ...
  (forall ( (A Int) (B Int) (C Bool) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Bool) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int) (S Int) ) 
    (=>
      (and
        ...
        (and (= E (ite C 1 0)) (= A P) (= F (+ D E)) (= L F) (= C (not (= B 0))))
      )
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Bool) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Bool) (L Bool) (M Int) (N Bool) (O Bool) (P Int) (Q Int) (R Bool) (S Bool) (T Bool) ) 
    (=>
      (and
        (main@_33 A B Q C D J P I M E F G H)
        (and (= O (or L K))
     (= R (not (<= P Q)))
     (= S (or N O))
     (= T (or S R))
...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E Int) (F Bool) (G Bool) (H Bool) (I Int) (J Int) (K Int) (L Int) (M Bool) (N Int) (O Int) (P Int) (Q Int) (R Int) (S Int) (T Int) ) 
    (=>
      (and
        (main@_33 I J K L M N E O P Q R S T)
        (and (= B (not (<= N K)))
     (= D (or B A))
     (= G (or C D))
     (= C (not (<= P E)))
     ...
     (= A (not (<= O N))))
      ...
      (main@_22 I J K L M N O P Q R S T)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Bool) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) ) 
    (=>
      ...
      (main@_42 A B C D E F G H I J K)
    )
  )
)
(assert
...
(assert
  (forall ( (A Bool) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) ) 
    (=>
      (and
        (main@_38 B C D E F G H I J)
        (and (not A) (= A (not (<= B D))))
      )
      (main@_40 B C D E F G H I J)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B Bool) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Bool) (M Bool) (N Bool) ) 
    (=>
      (and
        (main@_42 A J K I B C D E F G H)
...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Int) (E Int) (F Int) (G Int) (H Bool) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) ) 
    (=>
      (and
        (main@_42 D E F G H I J K L M N)
        (and (= C (or B A)) (= B (not (<= E F))) (not C) (= A (not (<= G E))))
      )
      (main@_45 D E F G H I J K L M N)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Bool) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) ) 
    (=>
      (and
        (main@_45 C A E F G H I J K L M)
        (and (= B (+ (- 1) A)) (= D B))
      )
      (main@_19 C D E F G H I J K L M)
    )
